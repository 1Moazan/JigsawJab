...
namespace Client
{
    public class MainMenuUiManager : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            playButton.onClick.AddListener(QuickMatchPressed);
        }
        ...
        private void OnDisable()
        {
            ...
            profileManager.GuestLoginSuccess -= GuestLoginSuccess;
            profileManager.AvatarUpdated -= AvatarUpdated;
            playButton.onClick.RemoveListener(QuickMatchPressed);
        }

        #region Matchmaking

        private void QuickMatchPressed()
        {
            SetLoading(true , "Finding Match...");
            matchmakingManager.StartMatchmaking(MatchMakeSuccess , MatchMakeFailure);
        }

        private void MatchMakeSuccess(ConnectionData connectionData)
        {
            sharedConnectionData.SetConnectionData(connectionData);
            SceneManager.LoadScene("Gameplay");
        }

        private void MatchMakeFailure(string obj)
        {
            SetLoading(false);
        }
        ...
        private void SetLoading(bool active, string message = "Loading...")
        {
            ...
            else loadingText.transform.DOKill();
        }
